            ...
            <ul class="nav navbar-nav navbar-right">
                <li>
                    <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown"
                        aria-expanded="false"><img src="<?php echo base_url('assets/images/img.jpg') ?>" alt="">Selamat
                        Datang
                    ...
                    <ul class="dropdown-menu dropdown-usermenu pull-right">
                        ...
                        <li><a href="<?php echo base_url() . "example/logout" ?>"><i class="fa fa-sign-out pull-right"></i>Logout</a></li>
                    </ul>
                ...
                <li role="presentation" class="dropdown">
                    <a href="javascript:;" class="dropdown-toggle info-number" data-toggle="dropdown"
                        ...
                        <span
                            class="badge bg-red"><?php $nulltol = $nullex + $nullstock ; if ($nulltol > 0) echo $nulltol ?></span>
                    </a>
