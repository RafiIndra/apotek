        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
                    ...
                    <li><a href="<?php echo base_url() . "example/index2" ?>"><i class="fa fa-home"></i> Dashboard </a>
                    </li>
                    ...
                    <li><a><i class="fa-solid fa-folder-plus"></i>Kategori & Unit <span
                    ...
                    <li><a><i class="fa-solid fa-truck-medical"></i> Pemasok <span
                                class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                    ...
                    <li><a><i class="fa-solid fa-dollar-sign"></i> Penjualan <span
                                class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                    ...
                    <li><a><i class="fa-solid fa-basket-shopping"></i> Pembelian <span
                                class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                    ...
                    <li><a href="<?php echo base_url('example/report') ?>"><i class="fa-solid fa-book"></i> Laporan </a>
                    </li>
