<?php if ($_COOKIE["username"] != "kasir" && $_COOKIE["username"] != "pemilik"){
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <form action="<?php echo base_url() . 'example/add_invoice'; ?>" method="post"
                    ...
                    <table id="prod" class="table table-bordered">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td>
                                    <input id="grandtotal" name="grandtotal" type="text" class="form-control grandtotal"
                                        readonly>
                                </td>
                            </tr>
                        </tfoot>
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                            ...
                            <button id='addRow' class="btn btn-info" type="button"><span class="fa fa-plus"></span>
